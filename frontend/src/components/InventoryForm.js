...
.simple-cart-table thead th:nth-child(2) { width: 35%; text-align: center; } /* QTY */
.simple-cart-table thead th:nth-child(3) { width: 35%; text-align: right; }  /* PRICE */
.simple-cart-table thead th:nth-child(4) { width: 35%; text-align: right; }  /* SUBTOTAL */
.simple-cart-table thead th:nth-child(5) { width: 25%; text-align: center; }
